...
[![volcanic-backend](https://img.shields.io/badge/volcanic-minds-orange)](https://github.com/hishprorg/possimus-iure)
[![npm](https://img.shields.io/badge/package-npm-white)](https://www.npmjs.com/package/@hishprorg/possimus-iure)
...
```ts
yarn add @hishprorg/possimus-iure
```
...
import { FastifyReply, FastifyRequest } from '@hishprorg/possimus-iure'
...
```ts
// src/config/roles.ts
import { Role } from '@hishprorg/possimus-iure'
...
import { JobSchedule } from '@hishprorg/possimus-iure'
